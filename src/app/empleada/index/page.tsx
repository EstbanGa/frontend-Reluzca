...
import { withEmpleadaRole } from "@/hoc/withRole";
...
function EmpleadaIndex() {
  ...
  const fetchData = async () => {
    try {
      ...
      const apiUrl = `${process.env.NEXT_PUBLIC_API_URL}/api/usuarios/empleada/dashboard/simple`;
