        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-15">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex space-x-4">
              <Link href="/auth/login" className="hidden md:inline-flex px-4 py-2 text-[#4894AD] border border-[#4894AD] rounded-lg hover:bg-[#4894AD] hover:text-white transition-all duration-300">
                  Iniciar Sesión
              </Link>
              <Link href="/auth/sign_up" className="px-6 py-2 bg-[#D95B26] text-white rounded-lg hover:bg-[#D95B26]/90 transition-all duration-300 shadow-lg hover:shadow-xl">
                  Crear Usuario
              </Link>
            </div>
          </div>
