...
function CrearReserva() {
  ...
  const cargarEmpleadas = async () => {
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/usuarios/empleadas`, {
        headers: {
  ...
  const cargarPlanes = async () => {
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/reservas/planes/`, {
        headers: {
          Authorization: `Bearer ${token}`,
          'Content-Type': 'application/json',
        },
  ...
  const cargarUbicaciones = async () => {
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/reservas/ubicaciones/`, {
        headers: {
          Authorization: `Bearer ${token}`,
          'Content-Type': 'application/json',
        },
  ...
  const cargarDisponibilidad = async (empleadaId: string) => {
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/reservas/empleadas/${empleadaId}/disponibilidad`, {
        headers: {
          Authorization: `Bearer ${token}`,
          'Content-Type': 'application/json',
        },
  ...
  const cargarHorariosDisponibles = async (planId: string, fechaEjemplo: string = '2024-01-01') => {
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/reservas/horarios/${planId}/${fechaEjemplo}`, {
        headers: {
          Authorization: `Bearer ${token}`,
          'Content-Type': 'application/json',
        },
  ...
  const cargarTareasExtra = async (planId: string) => {
    try {
      ...
      // URL CORREGIDA: Coincide con el patrón de Django
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/reservas/planes/${planId}/tareas-extra`, {
        headers: {
          Authorization: `Bearer ${token}`,
          'Content-Type': 'application/json',
        },
  ...
  const calcularPrecio = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/reservas/calcular-precio`, {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const crearReservas = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/reservas/crear`, {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
          'Content-Type': 'application/json',
